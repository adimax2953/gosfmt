...
```console
go get -u -v github.com/adimax2953/gosfmt
```
...
go test -benchmem -run=^$ -coverprofile=/var/folders/xy/g72c6j8n34z9lzxx46rk5d1h0000gn/T/vscode-goaou7XQ/go-code-cover -bench . github.com/adimax2953/gosfmt

goos: darwin
goarch: amd64
pkg: github.com/adimax2953/gosfmt
...
ok  	github.com/adimax2953/gosfmt	161.350s
